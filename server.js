...
app.get('/api/export', requireAuth, (req, res) => {
  try {
    const data = {
      ...
      chore_completions:   db.prepare('SELECT * FROM chore_completions').all(),
      ...
      vehicle_services:    db.prepare('SELECT * FROM vehicle_services').all(),
      vehicle_mileage:     db.prepare('SELECT * FROM vehicle_mileage').all(),
      home_appliances:     db.prepare('SELECT * FROM home_appliances').all(),
      home_consumables:    db.prepare('SELECT * FROM home_consumables').all(),
      home_maintenance:    db.prepare('SELECT * FROM home_maintenance').all(),
      home_repairs:        db.prepare('SELECT * FROM home_repairs').all(),
      ...
      member_health:       db.prepare('SELECT * FROM member_health').all(),
      contacts:            db.prepare('SELECT * FROM contacts').all(),
      pets:                db.prepare('SELECT * FROM pets').all(),
      pet_records:         db.prepare('SELECT * FROM pet_records').all(),
      ...
      countdowns:          db.prepare('SELECT * FROM countdowns').all(),
      goals:               db.prepare('SELECT * FROM household_goals').all(),
      messages:            db.prepare('SELECT * FROM messages').all(),
      packages:            db.prepare('SELECT * FROM packages').all(),
      polls:               db.prepare('SELECT * FROM polls').all(),
      school_classes:      db.prepare('SELECT * FROM school_classes').all(),
      school_members:      db.prepare('SELECT * FROM school_members').all(),
      ics_sources:         db.prepare('SELECT * FROM ics_sources').all(),
